...
echo "=== end to end ==="
SUITES="money.e2e internal-pages.e2e platform.e2e clientflow.e2e enquiry-to-engagement.e2e portal-promises.e2e upload-dedupe.test pipeline.e2e l7.e2e bid.e2e control.e2e interfaces.e2e challenge.e2e retention.e2e circle.e2e security.e2e seo.e2e"
