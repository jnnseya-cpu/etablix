...
echo "=== unit ==="
for t in clientflow.test workingdays.test pricing.test tenderpack.test seo.test indexnow.test mail.test pipeline.test concurrent.test store-kill.test; do
  printf '  %-22s ' "$t"
