...
export const DPS_SEED = [
  ...
  },
  {
    ...
    portal: "Confirm on the notice — CCS eSourcing",
    closingDate: "2029-02-23",
    lot: "Lower-value / less complex FM and workplace services",
    value: "£2,000,000,000",
    location: "United Kingdom",
    priority: 2,
    stage: "watching",
    fit: "The notice states the DPS exists for lower-value, less complex contracts and to attract SME suppliers — written for a company at our stage. Covers the operate phase: cleaning, waste, security, welfare management.",
    requires: ["el", "pl", "pi", "ssip", "hspolicy", "accounts", "refs2", "equality", "modernSlavery"],
    notes: "Second of the two to submit once insurance and SSIP land.",
  },
  {
    ...
    portal: "Confirm on the notice — CCS eSourcing",
    closingDate: "2029-02-23",
    lot: "Technical & Professional Services",
    value: "£800,000,000",
    location: "United Kingdom",
    priority: 3,
    stage: "preparing",
    ...
    notes: "Submit now — does not depend on having delivered anything as ETABLIX. Lead on the founder's delivery record and the interface-register method.",
  },
  {
