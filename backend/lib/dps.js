...
export const DPS_SEED = [
  ...
  },
  {
    ...
    priority: 4,
    stage: "preparing",
    fit: "Consultancy category matching Model 01, at a buyer in the Jewellery Quarter. The only route on our pipeline where the buyer is close enough to meet in person — local supplier status and local social value are a genuine advantage here, not a tie-breaker.",
    requires: ["pi", "el", "pl", "cdm", "cvs", "accounts", "equality"],
    notes: "60-month DPS, contract type Works, restricted procedure above threshold, SME suitable but not VCSE. Apply through Panacea for Category 1. No buyer email published on the notice — contact is listed only as CHIC TENDERS, so get the address from chicltd.co.uk or use the portal. Category 2 site clearance only on an explicit managed-supply-chain basis, never implying self-delivery. Ask for a face-to-face introduction: we are both Birmingham.",
  },
  {
