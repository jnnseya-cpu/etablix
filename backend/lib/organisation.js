...
export const FOUNDATIONS = [
  ...
  { id: "temporal", name: "Temporal reasoning", state: "built",
    ...
    where: "Both axes are recorded and a correction never edits. See L7.4. The limit is coverage rather than mechanism: contract events and awareness are written bitemporally, and most of the rest of the system still stores one current value.",
