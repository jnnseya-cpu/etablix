...
export const CATEGORIES = [
  ...
  },
  {
    ...
    events: [
      ...
      E("supplier.bid_received", "Bid received", "info", "email inapp", "Tender return — {{company}} for {{item}} ({{value}})", "A tender return has been received from {{company}} for {{item}}: {{value}}. Review it in the Control Desk and record the decision.", {}),
      E("supplier.nda_accepted", "NDA accepted", "info", "inapp", "NDA accepted — {{company}} for {{item}}", "{{actor}} of {{company}} electronically accepted the confidentiality undertaking for {{item}}. The enquiry pack is now open to them.", {}),
      E("supplier.po_issued", "Purchase order issued", "success", "email inapp", "ETABLIX purchase order {{reference}} — {{item}}", "We are pleased to confirm your appointment. Purchase order {{reference}} for {{item}} is issued at the agreed sum below, incorporating the ETABLIX framework terms you accepted at onboarding (certified payment with evidence, 30-day statutory terms, 5% capped retention, documented change control). This order and those terms form your contract. Raise applications for payment in your supplier portal quoting {{reference}}.", { a: "supplier" }),
      ...
      E("supplier.onboarding.sent", "Onboarding pack issued", "info", "email inapp", "ETABLIX — supplier onboarding for {{company}}", "Congratulations on prequalifying with ETABLIX. To complete onboarding, open your secure supplier portal at the link below: set up your payment structure (bank account, CIS and VAT details) and accept our framework terms. Once your bank details are verified by call-back, you can raise applications for payment directly in the portal.", { a: "supplier" }),
      E("supplier.onboarding.received", "Onboarding received — VERIFY BANK DETAILS", "warning", "email inapp", "Onboarding received — {{company}} — verify bank details by CALL-BACK before any payment", "{{company}} has completed supplier onboarding, including bank details. Do NOT pay against these until a named person has verified them by telephone call-back to the director contact on record. Verify, then mark the account verified in the Control Desk.", {}),
      E("payment.application.received", "Application for payment received", "info", "email inapp", "Payment application {{reference}} — {{company}} ({{value}})", "{{company}} has submitted application {{reference}} for {{value}}. Assess it against the evidence in the Control Desk — certification is due within the statutory notice period.", {}),
      E("payment.certified", "Payment notice issued", "info", "email inapp", "ETABLIX payment notice — {{reference}}", "This is our payment notice for your application {{reference}}. The sum we intend to pay and its basis are set out below. Payment will be made to your verified account by the due date.", { a: "supplier" }),
      E("payment.paid", "Payment made — remittance", "success", "email inapp", "ETABLIX remittance — {{reference}} paid", "Payment for application {{reference}} has been made to your verified account. The remittance breakdown is below. Thank you for working to the ETABLIX standard.", { a: "supplier" }),
